...
if __name__ == "__main__":
    ...
    # python .\train.py --img 512 --batch 2 --epochs 3 --data ..\yolov5_gesture\dataset.yml --weights ..\yolov5_gesture\yolov5s.pt
    # python .\detect.py --weights .\runs\train\exp9\weights\last.pt --img 512 --conf 0.05 --source .\data\images\ --name yolov5s_results
